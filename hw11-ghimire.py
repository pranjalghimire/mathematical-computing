...
SCP 
i)
with N=6 and c=1+i zk=20
zo=0,
z1=z0^2+c=0^2+(1+i)=1+i
z2=z1^2+c=(1+i)^2+(1+i)=1+3i     abs(z2)=sqrt(10)
z3=z2^2+c=(1+3i)^2+(1+i)=-7+7i   abs(z3)=sqrt(98)
z4=z3^2+c=(1+3i)^2+(1+i)=1-97i   abs(z4)=97.0>20

So z=4

ii)
Let N be the number of times to iterate
Let c be a complex number.
Let the initial value be z0 
Let the biggest value be zk 


For leading values of z,
let the formula for the nth value of z be 
z(n+1)=z(n)^2+c where n>=0

Iterate over each value of z
If absolute value of z is greater than zk,
return the nth value of z

If iteration value of z reaches greater than N,
return N
...
Initial value z0=0
z1= z0^2+c= 0^2+3+2i= 3+2i  abs(z1)=3.60<zk
z2= z1^2+c= (3+2i)^2+3+2i= 8+14i    abs(z2)=16.12<zk
z3= z2^2+c= (8+14i)^2+3+2i= -129+226i    abs(z3)=260.22>zk
The nth value is 3 
So, 3 is returned
